...
def landfast_ice_detection(date_str, plot=None):
    ...
    print('The total area of landfast sea ice is {} km^2'.format(lf_area.values))
    ...
    if plot != None:
        ...
        ax.plot(shortest_lon, shortest_lat,
                '.', color='C1',
                transform=ccrs.PlateCarree(),
                zorder=4, label='Ice edge closest to land')
    ...
    return(lf_lon, lf_lat, edge_dist, lf_area)